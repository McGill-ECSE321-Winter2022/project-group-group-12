 ...
 */
   ...
   * @return
   */
  private Address persistAddress(String fullName, String streetName, String city, String postalCode, String addressId,int streetNumber){
   ...
   * @return
   */
  private Employee persistEmployee(String email, String password, Address address, Set<Shift> setOfShifts, Boolean bool){
