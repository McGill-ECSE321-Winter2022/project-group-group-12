...
public class TestCustomerPersistence {
  ...
  public void testPersistAndLoadCustomersByUsername() {
    ...
    Address employeeAddress =
        persistAddress("ASAP Rocky", "Uni Street", 5, "Ottawa", "H6F 7U8", employeeAddressId);
    Employee employee =
        persistEmployee("rock@gm.com", "5678", "ASAP Rocky", employeeAddress, false);
    ...
    Address customerAddress1 =
        persistAddress("Tyler TheCreator", "Lorne Crescent", 4, "Montreal", "H2X 2B3", addressId1);
    Address customerAddress2 =
        persistAddress("Tyler TheCreator", "Montreal street", 8, "Montreal", "H2X 4B3", addressId2);
    Address customerAddress3 =
        persistAddress("Tyler TheCreator", "Unknown street", 22, "Montreal", "H2X 4H3", addressId3);

    List<Customer> expected = new ArrayList<Customer>(2);
    expected
        .add(persist("whodatboy@gm.com", name1, "1234", customerAddress1, setOfPurchases, false));
    expected
        .add(persist("whodatboy2@gm.com", name1, "5678", customerAddress2, setOfPurchases2, false));
  ...
  public void testPersistAndLoadCustomersByDisabled() {
    ...
    Address customerAddress2 =
        persistAddress("Tyler TheCreator", "Montreal street", 8, "Montreal", "H2X 4B3", addressId2);
    Address customerAddress3 =
        persistAddress("Drake", "Unknown street", 22, "Montreal", "H2X 4H3", addressId3);

    List<Customer> expected = new ArrayList<Customer>(2);
    expected.add(persist("whodatboy@gm.com", "Tyler TheCreator", "1234", customerAddress1,
        setOfPurchases, true));
    expected.add(
  ...
  public void testPersistAndLoadCustomersByEmail() {
    ...
    Customer expected =
        persist(email, "Tyler TheCreator", "1234", customerAddress1, setOfPurchases, false);
