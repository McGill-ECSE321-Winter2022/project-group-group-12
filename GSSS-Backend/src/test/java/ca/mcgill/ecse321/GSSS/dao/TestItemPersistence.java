...
public class TestItemPersistence {
	...
	/**
	 * This method helps create an Item, create its corresponding category, and save
	 ...
	 */
	public Item persist(String name, String description, String imageUrl, double price, int remainingQuantity,
			boolean availableForOrder, boolean stillAvailable, String categoryName) {
		ItemCategory category = persistItemCategory(categoryName);
		Item item = persistItem(name, description, imageUrl, price, remainingQuantity, availableForOrder,
				stillAvailable, category);

		return item;
	}

	/**
	 * This method creates an ItemCategory from the specified name, and saves it to
	 * the database.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	...
	/**
	 * This method creates an Item from the specified parameters, and saves it to
	 * the database.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	...
	/**
	 * This method asserts whether the actual list of items matches the expected
	 * one.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	...
	/**
	 * This method tests the create and read functionnalities for item by
	...
	/**
	 * This method tests the create and read functionnalities for item by catgory,
	...
	public void testLoadItemsByCategoryAndAvailableForOrderAndStillAvailable() {
		...
		List<Item> items2 = itemRepository.findItemsByCategoryAndAvailableForOrderAndStillAvailable(category, false,
				true);
		List<Item> items3 = itemRepository.findItemsByCategoryAndAvailableForOrderAndStillAvailable(category, false,
				false);
