...
public class TestItemPersistence {
  ...
  public void testLoadItemsByCategoryAndAvailableForOrderAndStillAvailable() {
    ...
    List<Item> items2 = itemRepository.findItemsByCategoryAndAvailableForOrderAndStillAvailable(
        category, false,
        true);
    List<Item> items3 = itemRepository.findItemsByCategoryAndAvailableForOrderAndStillAvailable(
        category, false,
        false);
