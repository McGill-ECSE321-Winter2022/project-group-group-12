...
/**
 * Test the loading and persistence of the Owner repository.
 *
...
public class TestOwnerPersistence {
   ...
   * @author Enzo Benoit-Jeannin
   */
  private Owner persist(String email, String username, String password, Address address,
      boolean disabled) {
  ...
  /**
   * Testing the persistence and loading for the Owner Repository. This tests the findOwnerByEmail
   * method
   *
   * @author Enzo Benoit-Jeannin
   */
  ...
  public void testPersistAndLoadOwnerByEmail() {
    ...
    Address address = persistAddress("Jeff Bezos", "Boss Avenue", 40, "Montreal", "W2S L0S",
        addressId);
  ...
  /**
   * Testing the persistence and loading for the Owner Repository. This tests the findOwnerByAddress
   * method
   *
   * @author Enzo Benoit-Jeannin
   */
  ...
  public void testPersistAndLoadOwnerByAddress() {
    ...
    Address address1 = persistAddress("Jeff Bezos", "Boss Avenue", 40, "Montreal", "W2S L0S",
        addressId1);
    Address address2 = persistAddress("Steve Jobs", "Poor Boss Avenue", 43, "Montreal", "W2S L0S",
        addressId2);
