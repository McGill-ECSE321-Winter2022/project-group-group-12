...
public interface EmployeeRepository extends CrudRepository<Employee, String> {
	...
	/**
	 * This method queries the database for an employee associated to a particular
	 * email.
	 * 
	...
	/**
	 * This method queries the database for a list of employees associated to a
	 * particular username (that isn't unique).
	 * 
	 ...
	 * @param disabled boolean to see if employee is banned, or in other words his
	 *                 account disabled
