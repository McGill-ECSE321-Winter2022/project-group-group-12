...
public interface ItemRepository extends CrudRepository<Item, String> {
	...
	/**
	 * This method queries the database for the unique item associated to the
	 * specified name.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	...
	/**
	 * This method queries the database for all of the items by availability for
	 * order.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	...
	/**
	 * This method queries the database for all of the items by availability in the
	 * shop.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	...
	/**
	 * This method queries the database for all of the items of a specified
	 * category.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	...
	/**
	 * This method queries the database for all of the items with specified
	 * category, and availability for order, and availability in shop.
	 * 
	 * @author Philippe Sarouphim Hochar.
	 * 
	 * @param category          Category of items.
